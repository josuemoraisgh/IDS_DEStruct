...
public:
    ...
    void setupUi(QDialog *DialogConfig)
    {
        ...
        sb_DC_Cromo->setObjectName(QStringLiteral("sb_DC_Cromo"));
        ...
        cb_DC_TComo->setObjectName(QStringLiteral("cb_DC_TComo"));
        ...
        cb_DC_config->setObjectName(QStringLiteral("cb_DC_config"));
        cb_DC_config->setChecked(true);

        verticalLayout->addWidget(cb_DC_config);

        pb_SArquivo = new QPushButton(groupBox_2);
        pb_SArquivo->setObjectName(QStringLiteral("pb_SArquivo"));
        ...
        sb_DC_Cromo_2->setObjectName(QStringLiteral("sb_DC_Cromo_2"));
        ...
        cb_DC_TComo_2->setObjectName(QStringLiteral("cb_DC_TComo_2"));
        ...
        sb_DC_Cromo_3->setObjectName(QStringLiteral("sb_DC_Cromo_3"));
        ...
        cb_DC_TComo_3->setObjectName(QStringLiteral("cb_DC_TComo_3"));
        ...
        cb_DC_Auto->setObjectName(QStringLiteral("cb_DC_Auto"));
        ...
        pb_DC_Concatenar->setObjectName(QStringLiteral("pb_DC_Concatenar"));

        horizontalLayout_2->addWidget(pb_DC_Concatenar);

        pb_DC_Carregar = new QPushButton(DialogConfig);
        pb_DC_Carregar->setObjectName(QStringLiteral("pb_DC_Carregar"));
        ...
        pb_DC_Salvar->setObjectName(QStringLiteral("pb_DC_Salvar"));

        horizontalLayout->addWidget(pb_DC_Salvar);

        pb_Fechar = new QPushButton(DialogConfig);
        pb_Fechar->setObjectName(QStringLiteral("pb_Fechar"));
