...
////////////////////////////////Classe /////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
ICarregar::ICarregar(SharedState *state, QWidget* parent)
    : DICarregar(parent)
    , m_state(state)
{
    setupUi(this);
...
void ICarregar::ativar(const bool &atv)
{
    ...
    else
    {
        ...
        else //Inicializa
        {
            ...
            m_state->Adj.Dados.variaveis.qtSaidas = LVSaida->selectionModel()->selectedIndexes().size();
            ...
            m_state->Adj.Dados.timeInicial = LETIni->text().toDouble()*pow(10.0,CBTIni->currentIndex()*(-3));
            m_state->Adj.Dados.timeFinal = LETFim->text().toDouble()*pow(10.0,CBTFim->currentIndex()*(-3));
            //Inicializando selecionando o arquivo
            m_state->cVariaveis = UL_cVariaveis;
            m_state->isCarregar = atv;
...
void ICarregar::slot_UL_Status(const quint16 &std)
{
    switch (std)
    {
        ...
        case 3:
            ...
            for(qint32 i=0;i<m_state->Adj.Dados.variaveis.nome.size();i++)
            {
...
{
    this->LVStBar2->setText(QString("Linhas: %1, Colunas: %2").arg(m_state->Adj.Dados.variaveis.valores.numLinhas()).arg(m_state->Adj.Dados.variaveis.valores.numColunas()));
}
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
