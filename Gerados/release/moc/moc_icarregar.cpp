...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ICarregar_t, stringdata) + ofs \
...
void ICarregar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ICarregar *_t = static_cast<ICarregar *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ICarregar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ICarregar::signal_UL_Normalizar)) {
                *result = 0;
            }
        }
        {
            typedef void (ICarregar::*_t)(const QList<quint32> * , const bool & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ICarregar::signal_UL_Carregar)) {
                *result = 1;
            }
        }
        {
            typedef void (ICarregar::*_t)(const quint16 & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ICarregar::signal_UL_Estado)) {
                *result = 2;
            }
        }
        {
            typedef void (ICarregar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ICarregar::signal_UL_SalvarArquivo)) {
                *result = 3;
            }
        }
        {
            typedef void (ICarregar::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ICarregar::signal_UL_FName)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject ICarregar::staticMetaObject = {
    { &DICarregar::staticMetaObject, qt_meta_stringdata_ICarregar.data,
      qt_meta_data_ICarregar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ICarregar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ICarregar.stringdata))
        return static_cast<void*>(const_cast< ICarregar*>(this));
